...
require_once($CFG->dirroot.'/phlcohort/training_schedule/upload/upload_form_lophoc.php');
...
$baseurl = new moodle_url('/phlcohort/training_schedule/upload/upload_lophoc.php', array('contextid' => $context->id));
...
$returnurl = new moodle_url('/phlcohort/training_schedule/upload/upload_lophoc.php');
if ($returnurl) {
